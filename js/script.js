...
// call to action 
        ...
        function sendEmail() {
            ...
            // Create email body
            var body = "Name: " + name + "<br>Email: " + email + "<br>Phone: " + phone + "<br>Service: " + service;

            // Send email
            Email.send({
                SecureToken : "4ea349f8-cb8d-4c15-8f78-9766d20c4816",
                To : 'info@yatiken.com',
                From : "info@yatiken.com",
  ...
  v.onload = function() {
    window.voiceflow.chat.load({
      verify: { projectID: '674978a07b0fed01c94b47f1' },
...
window.onscroll = function() {
    var aboutColumn = document.querySelector('.about-colmun');
    if (window.scrollY > aboutColumn.offsetTop) {
        aboutColumn.classList.add('sticky');
    } else {
        aboutColumn.classList.remove('sticky');
    }
};
