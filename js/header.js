            ...
            <div class="header-upper">
                <div class="container">
                    <ul class="top-left">
                        ...
                        <li><i class="fa fa-phone"></i><a href="tel:+91 120 490 283">+91 120 490 283</a></li>
                    </ul>
                    <div class="top-right">
                        <ul class="social-top">
                        ...
                        <div class="button-top">
                            <a href="../../contact.html#contact" class="btn-one style-one">Discuss a Problem</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <nav class="main-menu">
                                    ...
                                    <div class="navbar-collapse collapse clearfix">
                                        <ul class="navigation clearfix">
                                            ...
                                            <li class="dropdown">
                                                <a href="#">Our Collaboration</a>
                                                <ul>
                                                    <li><a href="../../our-collaboration/properties.html">Properties</a></li>
                                                    <li><a href="../../our-collaboration/evo-go.html">EVO Go</a></li>
                                                    <li><a href="https://captaincalling.com/" target="_blank">Captain Calling</a></li>
                                                    <li><a href="../../our-collaboration/water-drop.html">Water Drop</a></li>
                                                </ul>
                                                <div class="dropdown-btn"><span class="fa fa-angle-down"></span></div>
                                            </li>
                                            <li class="dropdown">
